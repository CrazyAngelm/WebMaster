-- AlterTable
ALTER TABLE "ItemTemplate" ADD COLUMN "shieldEvasionPenalty" INTEGER;
ALTER TABLE "ItemTemplate" ADD COLUMN "shieldType" TEXT;
...
INSERT INTO "new_BattleParticipant" ("activeEffects", "battleId", "bonusActions", "bonuses", "characterId", "currentHp", "currentProtection", "distance", "id", "initiative", "isPlayer", "mainActions", "maxHp", "maxProtection", "monsterTemplateId", "name") SELECT "activeEffects", "battleId", "bonusActions", "bonuses", "characterId", "currentHp", "currentProtection", "distance", "id", "initiative", "isPlayer", "mainActions", "maxHp", "maxProtection", "monsterTemplateId", "name" FROM "BattleParticipant";
